...
class TodoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return response()->json(['status'=>'success','message'=>'ToDo List Added Successfully!','data'=>$todo]);
    }
     ...
     *          description="invalid",
     *          @OA\JsonContent(
     *              @OA\Property(property="msg", type="string", example="Unable to Update Todo List"),
     *          )
     *      )
     * )
     */
    public function update($id, Request $request){
        try {
            ...
            return response()->json(['status'=>'success','message'=>'ToDo List Updated Successfully!','data'=>$todo]);
        }catch (ModelNotFoundException $exception){
            return response()->json(['status'=>'Failed!',"msg"=>$exception->getMessage()],404);
        }
    }
